...
class FillPermissionsForTranslatable extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTranslatable constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.translatable',
            'admin.translatable.index',
            'admin.translatable.create',
            'admin.translatable.show',
            'admin.translatable.edit',
            'admin.translatable.delete',
            'admin.translatable.bulk-delete',
        ]);
